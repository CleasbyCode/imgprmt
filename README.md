...
```
Using the required, default command-line arguments (*imgprmt my_image.jpg*) without any options, the embedded image can only be posted on ***Tumblr***, ***Mastodon*** & ***Flickr***. The ***Linux*** command-line version of ***imgprmt*** is limited to 4096 characters for your prompt text.  
The ***Windows*** command-line version and the ***imgprmt*** Web App has a prompt text limit of 59392 characters.
