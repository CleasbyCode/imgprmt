...
***imgprmt*** is a command-line tool for ***Linux*** and ***Windows*** that embeds your AI image text prompts/descriptions into JPG images. It creates a unique ***JPG-HTML*** polyglot file, combining image, prompt text & html in a single output.  
