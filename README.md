...
***imgprmt*** is a command-line tool for storing and sharing your favorite AI image text prompts. The tool embeds them into ***JPG*** images and creates a unique ***JPG-HTML*** polyglot file, combining image, prompt text & html in a single output.  
