...
***imgprmt*** is a command-line tool for storing and sharing your favorite AI image text prompts by embedding them into JPG images. It creates a unique ***JPG-HTML*** polyglot file, combining image, prompt text & html in a single output.  
